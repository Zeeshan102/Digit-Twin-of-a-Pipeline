...
if not layer.isValid() or layer.geometryType() != QgsWkbTypes.LineGeometry or not raster_layer.isValid():
    ...
    for feature in layer.getFeatures():
        ...
        results.extend([start_value, end_value])

    # Specify the path to the output text file
    output_text_path = 'F:\Internship at DTNEC\QGIS Pipeline\Excel automation\Raster_Values.txt'
    ...
    print(f"Elevation/Raster values saved to {output_text_path}")
